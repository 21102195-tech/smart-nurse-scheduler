...
st.markdown("<h5 style='color: gray; font-weight: normal;'>간호사들은 오프를 신청하고, 수간호사님은 관리자 인증 후 근무표를 자동 생성할 수 있습니다.</h5>", unsafe_allow_html=True)
st.markdown("---")
...
# 앱이 재부팅되거나 다른 사용자가 들어와도 서버 디스크에 구워져 있는 파일들을 자동 복원합니다.
...
# ----------------- ⭐ [삼중 탭 레이아웃 설계] -----------------
# 템플릿 파일이 아예 없어도 이 3개의 메뉴 단추는 화면에 "무조건 100% 항상" 보여집니다!
...
with tab_result:
    ...
    if admin_password_gen == "1234":
        ...
        st.info("💡 올바른 비밀번호(1234)를 입력해 주시면 근무표 작성 및 관리자 제어판 도구들이 활짝 열립니다.")
